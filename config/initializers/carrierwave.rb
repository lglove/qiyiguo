...
CarrierWave.configure do |config|
  ...
  #config.aliyun_host       = Rails.env == "production" ? "http://image.uubpay.com" : "http://image.uubpay.com"
  ...
  #config.aliyun_upload_host = "http://uubimages.oss-cn-qingdao.aliyuncs.com"
end
