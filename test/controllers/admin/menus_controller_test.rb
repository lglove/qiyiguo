...
class Admin::MenusControllerTest < ActionController::TestCase
  ...
  test "should create admin_menu" do
    assert_difference('Admin::Menu.count') do
      post :create, admin_menu: { hide: @admin_menu.hide, parent_id: @admin_menu.parent_id, position: @admin_menu.position, text: @admin_menu.text, url: @admin_menu.url }
    end
  ...
  test "should update admin_menu" do
    patch :update, id: @admin_menu, admin_menu: { hide: @admin_menu.hide, parent_id: @admin_menu.parent_id, position: @admin_menu.position, text: @admin_menu.text, url: @admin_menu.url }
    assert_redirected_to admin_menu_path(assigns(:admin_menu))
  end
